...
const LoaderSizeMIcon: React.FC<IconProps> = ({ width = 48, height = 48, color = 'primary', ...props }) => {
  const colorMap = {
    primary: '#000000',
    secondary: '#afadb5',
    accent: '#1f883d',
  ...
  return (
    <svg width={width} height={height} {...props} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
export default React.memo(LoaderSizeMIcon);
