...
const LoaderSizeLIcon: React.FC<IconProps> = ({ width = 60, height = 60, color = 'primary', ...props }) => {
  const colorMap = {
    primary: '#000000',
    secondary: '#afadb5',
    accent: '#1f883d',
  ...
  return (
    <svg width={width} height={height} {...props} viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
export default LoaderSizeLIcon;
